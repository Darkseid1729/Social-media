    ...
    <>
      ...
      >
        <IconButton onClick={handleMobile}>
          <MenuIcon sx={{ color: theme.PRIMARY_COLOR }} />
        </IconButton>
      </Box>
      ...
      <Tooltip title="back">
        ...
        >
          <KeyboardBackspaceIcon sx={{ color: theme.PRIMARY_COLOR }} />
        </IconButton>
      </Tooltip>
    </>
  );
      ...
      {isEdit ? (
        <>
          ...
          <IconButton onClick={updateGroupName} disabled={isLoadingGroupName}>
            <DoneIcon sx={{ color: theme.PRIMARY_COLOR }} />
          </IconButton>
        </>
      ) : (
        <>
  ...
  const ButtonGroup = (
    ...
    >
      ...
      <Button
        size="large"
        variant="contained"
        startIcon={<AddIcon sx={{ color: theme.PRIMARY_COLOR }} />}
